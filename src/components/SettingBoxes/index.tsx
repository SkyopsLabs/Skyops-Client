...
const SettingBoxes = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-4 bg-white p-5 lg:mx-4 lg:mb-3 lg:mt-6 lg:p-6">
        {/* General Part */}
        ...
        <div className="flex flex-col gap-2 lg:flex-row lg:gap-3">
          {/* Organization ID */}
          <input
            className=" h-[60px]  w-full  border-[1px] border-black/10 bg-white px-4.5 py-2.5 text-black/30 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary lg:w-1/3"
            type="text"
      ...
      <div className="mb-4 bg-white p-5 lg:mx-4 lg:mb-3 lg:mt-6 lg:p-6">
        ...
        <div className="grid h-[56px] grid-cols-[0.5fr,1.2fr,1fr,0.7fr] border-b border-border2 px-4 py-3 dark:border-dark-3 md:px-6 lg:h-[64px]  lg:grid-cols-[1.5fr,1fr,1fr,1fr] 2xl:px-7.5">
          <div className="flex items-start">
            <p className="text-xs text-black/50 lg:text-sm">Name</p>
          </div>
          <div className="flex items-start justify-center lg:justify-start">
            <p className="text-xs text-black/50 lg:text-sm">Address</p>
          </div>
          <div className="flex items-start">
            <p className="text-xs text-black/50 lg:text-sm">Joined</p>
          </div>
          <div className="flex items-start">
            <p className="text-xs text-black/50 lg:text-sm">Role</p>
          </div>
        </div>
        {/* Body */}
        {members.map((item, index) => (
          ...
          >
            <div className="flex items-start">
              <p className="text-xs text-appBlack lg:text-sm">{item.name}</p>
            </div>
            <div className="flex items-start">
              <p className="text-xs text-appBlack lg:text-sm">{item.address}</p>
            </div>
            <div className="flex items-start">
              <p className="text-xs text-appBlack lg:text-sm">{item.joined}</p>
            </div>
            <div className="flex items-start">
              <p className="text-xs capitalize text-appBlack lg:text-sm">
                {item.role}
              </p>
            </div>
          </div>
      ...
      <div className="mb-4 bg-white p-5 lg:mx-4 lg:mb-3 lg:mt-6 lg:p-6">
        ...
        <div className="grid  h-[56px] grid-cols-[1fr,0.7fr,0.7fr,1fr] border-b border-border2 px-4  py-3 dark:border-dark-3 md:px-6 lg:h-[64px] lg:grid-cols-[1.5fr,1fr,1fr,1fr] 2xl:px-7.5">
          <div className="flex items-center">
            <p className="text-xs text-black/50 lg:text-sm">Quota Name</p>
          </div>
          <div className="flex items-center">
            <p className="text-xs text-black/50 lg:text-sm">Default Value</p>
          </div>
          <div className="flex items-center">
            <p className="text-xs text-black/50 lg:text-sm">Current Value</p>
          </div>
          <div className="flex items-center">
            <p className="text-xs text-black/50 lg:text-sm">Utilization</p>
          </div>
        </div>
        ...
        <div className="grid h-[56px] grid-cols-[1fr,0.7fr,0.7fr,1fr] place-content-center border-b border-border2 px-4 pb-3 dark:border-dark-3 md:px-6 lg:h-[64px]  lg:grid-cols-[1.5fr,1fr,1fr,1fr] 2xl:px-7.5">
          <div className="flex items-start">
            <p className="text-xs text-appBlack lg:text-sm">{"-"}</p>
          </div>
          <div className="flex items-start">
            <p className="text-xs text-appBlack lg:text-sm">{"-"}</p>
          </div>
          ...
          <div className="flex items-start">
            <p className="text-xs capitalize text-appBlack lg:text-sm">{"-"}</p>
          </div>
        </div>
      </div>
    </div>
