  ...
  return (
    <div className="w-full sm:w-2/3">
      <div className="relative">
        <input
          className="w-full rounded-[7px] border-[1.5px] border-stroke bg-white px-4.5 py-2.5 pr-12.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
        ...
        >
          {isPasswordVisible ? (
            ...
            >
              <g>
                <path d="M12.5,9A3.5,3.5,0,1,0,16,12.5,3.5,3.5,0,0,0,12.5,9Zm0,6A2.5,2.5,0,1,1,15,12.5,2.5,2.5,0,0,1,12.5,15Zm9.491-2.5a.5.5,0,0,0,0-.1.454.454,0,0,0-.041-.108.512.512,0,0,0-.025-.065l-.01-.014,0,0c-.207-.324-3.461-5.232-9.41-5.232s-9.2,4.908-9.41,5.232l0,0-.01.014a.512.512,0,0,0-.025.065.454.454,0,0,0-.041.108,1.506,1.506,0,0,0,0,.19.471.471,0,0,0,.041.108.512.512,0,0,0,.025.065l.01.014,0,0c.206.323,3.46,5.232,9.41,5.232s9.2-4.909,9.41-5.232l0,0,.01-.014a.512.512,0,0,0,.025-.065.471.471,0,0,0,.041-.108A.5.5,0,0,0,21.991,12.5ZM12.5,17.017c-4.708,0-7.646-3.516-8.388-4.517.742-1,3.68-4.517,8.388-4.517S20.146,11.5,20.888,12.5C20.146,13.5,17.208,17.017,12.5,17.017Z" />
              </g>
            </svg>
          )}
        </button>
        <button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute right-10 top-1/2 mt-1 -translate-y-1/2"
            width="45"
            height="45"
            viewBox="0 0 28 28"
            fill="currentColor"
        ...
        <button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute right-1 top-1/2 mt-1 -translate-y-1/2"
            width="45"
            height="45"
            viewBox="0 0 28 28"
            fill="currentColor"
