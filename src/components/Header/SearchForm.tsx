...
const SearchForm = ({ search, setSearch }: any) => {
  return (
      ...
      <form action="https://formbold.com/s/unique_form_id" method="POST">
        <div className="relative w-full max-w-[300px]">
          ...
          <input
            ...
            className="w-full rounded-[10px] border border-stroke bg-gray-1 py-3 pl-13.5 pr-5 text-dark focus:border-primary focus:outline-none dark:border-dark-4 dark:bg-dark-3 dark:text-white dark:focus:border-primary xl:w-[300px]"
          />
        </div>
      </form>
    </li>
