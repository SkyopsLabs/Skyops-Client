...
const SelectGroup: React.FC = () => {
  ...
  return (
    <div
      className="relative z-50 bg-transparent dark:bg-dark-2"
      style={{ width: "180px" }}
    >
      <select
        ...
        className={`relative z-20 w-full appearance-none rounded-[7px] border border-stroke bg-transparent px-5.5 py-2.5 outline-none transition focus:border-primary active:border-primary dark:border-dark-3 dark:bg-dark-2 dark:focus:border-primary ${
