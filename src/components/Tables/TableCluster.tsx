    ...
    <div className="flex w-full flex-col">
      ...
      <div className="w-full overflow-x-scroll  lg:w-auto">
        ...
        {clusters.map((item, index) => (
          <div key={index.toString()} className="mx-4 mb-[6px] grid  h-[72px] w-full min-w-[700px] grid-cols-[1fr,1fr,0.5fr,0.5fr,1fr,0.7fr] border-stroke bg-white px-5 py-4.5 dark:border-dark-3 md:px-10  lg:w-auto">
            <div className="flex items-center">
              <Checkbox />
