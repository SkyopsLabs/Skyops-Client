      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="max-h-[60vh]   flex-1 overflow-y-scroll lg:max-h-[68vh]">
          {new Array(30)
            ...
            .map((item, index) => (
              <div key={index.toString()} className="mb-[6px] grid h-[56px] grid-cols-[1fr,2fr,1fr] bg-white px-5 dark:bg-dark-2 lg:h-[64px] lg:grid-cols-[1.5fr,2fr,2fr,1fr] lg:px-10">
